...
import { ArrowUpDown, CirclePlus, Eye, Trash } from "lucide-react";
...
export default function InjectorsTable() {
      ...
      <div className="flex items-center justify-between py-4 gap-8">
        ...
        <Link to="/injectors/add">
          <Button>
            ...
            <p className=" max-sm:hidden sm:hidden md:block">Agregar Injector</p>
          </Button>
        </Link>
      </div>
